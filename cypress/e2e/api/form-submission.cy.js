...
describe('Form Submissions API Field Validation Spec', () => {
  ...
  describe('POST /api/consultation', () => {
    ...
    it('[Test-103] should successfully submit a valid consultation request', () => {
    ...
    it('[Test-104] should reject submission when email format is invalid', () => {
      cy.get('@homeData').then((homeData) => {
    ...
    it('[Test-105] should reject submission when required fields are missing', () => {
      cy.get('@homeData').then((homeData) => {
  ...
  describe('POST /api/partnership', () => {
    ...
    it('[Test-106] should successfully submit a valid partnership inquiry', () => {
    ...
    it('[Test-107] should reject inquiry when email format is invalid', () => {
      cy.get('@partnersData').then((partnersData) => {
    ...
    it('[Test-108] should reject inquiry when mandatory fields are missing', () => {
      cy.get('@partnersData').then((partnersData) => {
